...
module.exports = {
    name:'set-bg',
    aliases:['set-bg','set-background','setbg','setbackground'],
                ...
                if(userData.premiumtype === 3){
                    if(args[0]){
                       ...
                       if(imagethere === true){
                        ...
                        embed.setAuthor(`${message.author.username}, your background has been set successfully!`);
                        ...
                        const embed = new Discord.MessageEmbed();
                        embed.setAuthor(`${message.author.username}, your background has been removed successfully!`);
                        embed.setColor(`#30CC71`);
                        message.channel.send({embeds:[embed]});
                    }
                }else{
                    ...
                    embed.setDescription(`${message.author.username}, you require 3rd tier premium for this command`);
